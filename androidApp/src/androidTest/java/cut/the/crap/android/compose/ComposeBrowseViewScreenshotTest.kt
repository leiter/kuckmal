 ...
 *
 * Run with:
 * ./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=cut.the.crap.android.compose.ComposeBrowseViewScreenshotTest
 *
 * Or run specific test:
 * ./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=cut.the.crap.android.compose.ComposeBrowseViewScreenshotTest#captureBrowseView
 */
