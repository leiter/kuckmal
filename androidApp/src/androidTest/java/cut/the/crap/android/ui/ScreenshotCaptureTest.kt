 ...
 *
 * Run with:
 * ./gradlew connectedAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=cut.the.crap.android.ui.ScreenshotCaptureTest
 */
...
class ScreenshotCaptureTest {
    ...
    fun captureAllScreenshots() = uiTest("CaptureScreenshots") {
        ...
        println("1. External storage: /sdcard/Android/data/cut.the.crap/files/test-screenshots/")
        println("2. tmp/ directory (via copyScreenshotToTmp)")
        println("")
        println("To pull screenshots:")
        println("adb pull /sdcard/Android/data/cut.the.crap/files/test-screenshots/ ./tmp/")
    }
