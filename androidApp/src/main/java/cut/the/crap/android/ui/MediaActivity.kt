...
import cut.the.crap.android.compose.ComposeActivity
    ...
    fun checkForUpdatesManually() {
        lifecycleScope.launch {
            try {
                ...
                when (result) {
                    is cut.the.crap.android.util.UpdateChecker.UpdateCheckResult.UpdateAvailable -> {
                        Log.i(TAG, "Update available - prompting user")
                        showUpdateAvailableDialog(viewModel)
                    }
                    is cut.the.crap.android.util.UpdateChecker.UpdateCheckResult.NoUpdateNeeded -> {
                    ...
                    is cut.the.crap.android.util.UpdateChecker.UpdateCheckResult.CheckFailed -> {
                    ...
                    is cut.the.crap.android.util.UpdateChecker.UpdateCheckResult.CheckSkipped -> {
