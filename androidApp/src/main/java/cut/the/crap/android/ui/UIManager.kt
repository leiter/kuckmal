...
import cut.the.crap.android.ui.adapter.BroadCasterListAdapter
import cut.the.crap.android.ui.adapter.MediaBrowseAdapter
...
class UIManager(
     ...
     */
    fun updateContentListFromFlow(entries: List<cut.the.crap.shared.database.MediaEntry>) {
        val currentView = viewModel.viewState.value
     ...
     */
    fun updateDetailViewFromFlow(mediaEntry: cut.the.crap.shared.database.MediaEntry?) {
        if (mediaEntry == null) {
